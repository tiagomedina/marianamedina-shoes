...
var StoreProductsFilter$=(function(){
  ...
  function fnMain(){
    ...
    if(typeof(FCLib$.pQuery)=="object" && FCLib$.pQuery!=null && oFilOut){
        ...
        for(var i in opFil){
          ...
          if(typeof(oItemFil)=="object" && (opFil[i].show || opFil[i].show==undefined)){
            ...
            if(iQtdFound>0){           
              ...
              //>>>>>>>>>>>>>>>>>  exemplo para vir fechado os filtros, exceto marca ou filtros usados na busca atual
              if(oFiltro.name=="xMarca" || sLiChecked!=""){sDisplay="";sSeta="SetaBaixo";} //só vem aberto o filtro Marca ou se estiver usando o filtro na busca
              else{sDisplay=" style=display:none;";sSeta="SetaDireita";}//filtros são listados fechados

              if(iQtdFound>iMaxItems)sSearch+="<li class='FilInputSearch FilInfo"+ i +"'"+ sDisplay +"><input maxlength="+ iMaxSearch +" class=SearchFil placeholder='"+ aXYZ[4][IdiomaLoja] +" "+ oFiltro.name +"' onkeyup='StoreProductsFilter$.fnSearchFil(this.value,"+ i +");' type=text></li>"

              //>>>>>>>>>>>>>>>>> exemplo de mudar a ordem dos filtros, guarda em sHTMLFilPrimeiro o filtro Cor e depois coloca em primeiro
              //if(oFiltro.name=="Cor"){sHTMLFilPrimeiro="<li class='FilName Fil"+ i +"' onclick='StoreProductsFilter$.fnHideFil("+i+")'><span id='FilName"+i+"' class='"+ sSeta +"'>"+ aXYZ[0][IdiomaLoja] +" "+ oFiltro.name +"</span></li>"+ sSearch +"<li class='FilItems FilInfo"+ i +"'"+ sDisplay +"><ul id=FilItemsList"+ i +" class=FilItemsList>"+ sLiChecked + sLiUnChecked +"</ul></li>";}
              //else {sHTML+="<li class='FilName Fil"+ i +"' onclick='StoreProductsFilter$.fnHideFil("+i+")'><span id='FilName"+i+"' class='"+ sSeta +"'>"+ aXYZ[0][IdiomaLoja] +" "+ oFiltro.name +"</span></li>"+ sSearch +"<li class='FilItems FilInfo"+ i +"'"+ sDisplay +"><ul id=FilItemsList"+ i +" class=FilItemsList>"+ sLiChecked + sLiUnChecked +"</ul></li>";}
              sHTML+="<li class='FilName Fil"+ i +"' onclick='StoreProductsFilter$.fnHideFil("+i+")'><span id='FilName"+i+"' class='"+ sSeta +"'>"+ aXYZ[0][IdiomaLoja] +" "+ oFiltro.name +"</span></li>"+ sSearch +"<li class='FilItems FilInfo"+ i +"'"+ sDisplay +"><ul id=FilItemsList"+ i +" class=FilItemsList>"+ sLiChecked + sLiUnChecked +"</ul></li>";
      ...
      if(bExibeCats){
        ...
        if(typeof(opCat)=="object"){
          if(opCat.length>1){
            ...
            if(y>iMaxItems)sSearch+="<li class='FilInputSearch FilInfoCat' style=display:none;><input maxlength="+ iMaxSearch +" class=SearchFil placeholder='"+ aXYZ[4][IdiomaLoja] +" "+ aXYZ[6][IdiomaLoja] +"' onkeyup='StoreProductsFilter$.fnSearchCat(this.value);' type=text></li>"
      ...
      //>>>>>>>>>>>>>>>>> colocando filtro Cor em primeiro lugar sHTMLFilPrimeiro
      if(sHTML!="")sHTML="<ul class=FilSearch>"+ sHTMLFilPrimeiro +"</ul>"+ sHTML;
        ...
        for (var i=1;i<4;i++){
          ...
          if(typeof(oA[i])=="object"){
            ...
            if(typeof(oItemAdic)=="object"){
              ...
              if(iQtdFound>0){
                if(iQtdFound>iMaxItems)sSearch+="<li class='FilInputSearch FilInfoAdic"+ i +"' style=display:none;><input maxlength="+ iMaxSearch +" class=SearchFil placeholder='"+ aXYZ[4][IdiomaLoja] +" "+ oAdic.name +"' onkeyup='StoreProductsFilter$.fnSearchAdic(this.value,"+ i +");' type=text></li>"
                sHTMLAdic+="<li class='FilName Adic"+ i +"' onclick='StoreProductsFilter$.fnHideFil(\"Adic"+i+"\")'><span id='FilNameAdic"+i+"' class='SetaDireita'>"+ aXYZ[0][IdiomaLoja] +" "+ oAdic.name +"</span></li>"+ sSearch +"<li class='FilItems FilInfoAdic"+ i +"' style=display:none;><ul id=AdicItemsList"+ i +" class=FilItemsList>"+ sLiChecked + sLiUnChecked +"</ul></li>";
              }
            }
...
if(FC$.Page="Products")FCLib$.onReady(StoreProductsFilter$.fnInit());

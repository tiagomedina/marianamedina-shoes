...
function PopNews(){ 
  ...
  if(FC$.Page=="Home" && cookie!="true" && isMobile.any() == null){
  
  jQuery(document).ready(function(){
  jQuery('#popupNews, #FullBackground, #modalParent').css('display', 'block');
  ...
  var backgroundDois = jQuery("#modalParent")
  if(backgroundDois){
  jQuery('body,html').css('overflow','hidden');
  }
  
  jQuery("#btnFechar").click(function(){
  jQuery('#popupNews, #FullBackground, #modalParent').fadeOut(300);
  ...
  {
    jQuery('body,html').css('overflow','auto');
   	jQuery('#popupNews, #FullBackground, #modalParent').fadeOut(0);

jQuery3.fn.megamenu = function(options){
	var settings = {
	...
	$(menu).prepend("<li class='showhide blue'><span class='title'>CATEGORIAS</span><span class='icon1'></span><span class='icon2'></span></li>");
	screenSize();

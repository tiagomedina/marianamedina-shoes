...
var StoreProductsFilter$=(function(){
  ...
  aXYZ[3]=["Mais opções de busca","More search options","Más opciones de búsqueda","Mais opções da busca","products-filter-more-options"];
  aXYZ[4]=["Buscar","Search","Buscar","Buscar","products-filter-search"];
  aXYZ[5]=["não encontrado com o termo","not found with the term","no encontrado con el término","não encontrado com o termo","products-filter-not-found"];
  ...
  aXYZ[8]=["Termo","Term","Búsqueda","Termo","products-filter-term"];
  aXYZ[9]=["Promoções","On sale","En oferta","Promoções","products-filter-on-sale"];
  aXYZ[10]=["Lançamentos","New Releases","Novedades","Lançamentos","products-filter-new-releases"];
  aXYZ[11]=["de","min.","de","de","products-filter-price-min"];
  aXYZ[12]=["até","max.","hasta","até","products-filter-price-max"];
  aXYZ[13]=["Sim","Yes","Sí","Sim","products-filter-yes"];
  aXYZ[14]=["Remover este filtro","Remove this filter","Quitar este filtro","Remover este filtro","products-filter-remove-this-filter"];
  aXYZ[15]=["Alterar termo de busca","Change the search term","Cambiar el término de búsqueda","Alterar o termo da busca","products-filter-change-search-term"];
  aXYZ[16]=["Buscar por este termo","Search for this term","Búsqueda de este término","Buscar por este termo","products-filter-search-for-this-term"];
  aXYZ[17]=["Cancelar alteração de termo de busca","Cancel search term change","Cancelar cambio del término de búsqueda","Cancelar a alteração do termo da busca","products-filter-cancel-search-term-change"];
  ...
  function fnMain(){
    ...
    if(oFilOut==null){ /*se não encontrou nenhum elemento com o id ProductsFilterFC, tenta criar uma div com o id ProductsFilterFC dentro da div que tem a classe left-bar no modelo de loja*/
  ...
  function fnRemoveFilter(iTipo,IsFiltro){
    ...
    if(iTipo==0 || cat.url==""){  /*se esta removendo categoria ou não tem url da categoria*/
      sURL=FCLib$.uk("url-prod");
  ...
  /*função para coletar os parâmetros iniciais que serão usados em link para remover todos os filtros*/

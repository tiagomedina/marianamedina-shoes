...
if(sPag.indexOf("YPREDIR.ASP") != -1) {
  ...
  else
  {
    ...
    newNode.innerHTML = "Para trocar a bandeira do cart�o de cr�dito e efetuar o pagamento voc� precisa <strong>refazer o seu pedido</strong>, mas n�o se preocupe, � bem f�cil:<br><br>- Clique no link abaixo<br>- Fa�a o login (caso ainda n�o esteja logado)<br>- Clique no bot�o verde da p�gina indicando para refazer o pedido<br><br><a href='https://www.bebefofuxo.com.br/track.asp?numpedido="+num_pedido+"'>Desejo trocar a bandeira do cart�o</a>";

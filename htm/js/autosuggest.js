...
var g2='3'; //Quantidade de itens do grupo g2(Páginas), Padrão 3, Máximo 9, 0 Não exibe
var g3='5'; //Quantidade de itens do grupo g3(Produtos), Padrão 5, Máximo 9, 0 Não exibe
var g4='3'; //Quantidade de itens do grupo g4(Notícias), Padrão 3, Máximo 9, 0 Não exibe

var url_busca = "autosuggest.asp?idloja=";
var url_atual = window.location.href;
if(url_atual.includes("/categorias/"))
{
  url_busca = "../autosuggest.asp?idloja=";
}
...
jQuery(function (jQuery) {
            ...
            jQuery("#autocomplete").autocomplete({
              ...
              source: function (request, response) {
                  jQuery.ajax({
                      url: url_busca+FC$.IDLoja+"&format=1&q="+request.term+"&g1="+g1+"&g2="+g2+"&g3="+g3+"&g4="+g4,
                      dataType: "json",
                      type: "GET",                     
              ...
              minLength: 3
								...
								jQuery('li.active:even').css('background-color', '#fff'); //A cor original era #f1efef
                    ...
                    .data("item.autocomplete", item)
					          ...
					          if(item.fp!=item.op){
					            sSale="<div class='as-selo-sale'>"+FormatNum(Math.round(((item.op-item.fp)/item.op)*100))+"%&nbsp;off</div>";}
					          else{
					            sSale=""
					          }
